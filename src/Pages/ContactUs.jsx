    ...
    const contactInfo = [
        {
            ...
            heading : "Chat on us",
            subheading : <p>Our friendly team is here to help.<br/><a href='mailto:abrolmannat08@gmail.com'>abrolmannat08@gmail.com</a></p>
        },
        {
            icon : <GiEarthAmerica className='w-[24px] h-[24px]'/>,
            heading : "Visit us",
            subheading : <p>Come and say hello at our office HQ.<br/>MBSCET JAMMU</p>
        },
        {
